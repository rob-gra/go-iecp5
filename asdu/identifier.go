...
// about data unit identification: the ASDU data unit identifier
...
// F for file transfer.
// <0> not used
// <1..127> defined by the standard - compatible
// <128..135> reserved for routing messages - private
// <136..255> special use - private
// NOTE: whether an information object carries a time tag is distinguished by
// the type identification, not by the object itself.
const (
	_ TypeID = iota // 0: not defined
	// Process information in the monitor direction <0..44>
	...
	// System information in the monitor direction <70..99>
...
// seq: bit7
// 0: a set of information elements of the same type at different object
// addresses, i.e. (address + element) * N
// 1: a sequence of information elements of the same type starting at one
// object address, i.e. (one address, N elements)
...
// String returns the variable structure qualifier as a string.
...
// | T | P/N | 5..0 cause |
// T = test, the cause of transmission for testing. 0: not a test, 1: test
// P/N indicates the negative (or positive) confirmation.
// Cause is the cause of transmission. bit5 - bit0
// Positive or negative confirmation of an activation requested by the
// originating application function. 0: positive, 1: negative.
...
// <0> undefined
// <1..63> cause-of-transmission number
// <1..47> defined by the standard
// <48..63> private range
// NOTE: whether an information object carries a time tag is distinguished by
// the type identification, not by the object itself.
const (
...
// String returns the Cause as a string, including ",neg" and ",test" where
// those flags apply.
